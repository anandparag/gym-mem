			...
			%>
				<tr>
				  ...
				  <% if(session.getAttribute("login_level").equals("2")) { %>	
					<a href="customer.jsp?customer_id=<% out.print(CustomerDetails.get("customer_id")); %>">View Details</a></a>
				  <% } else { %>
					<a href="customer.jsp?customer_id=<% out.print(CustomerDetails.get("customer_id")); %>">Edit Customer</a></a>
				  <% } %>
				  </td>
				</tr>
			<%
